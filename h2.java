...
public class h2 {
    ...
    public static void main(String[] args) {
        ...
        double[] kiirused = sportspeed();
        double kiirus1 = kiirused[0];
        double kiirus2 = kiirused[1];
        kiirusteerinev(kiirus1, kiirus2);
        tollmeeter();
        ellipspind();
        minuttund();
    }
    ...
    static void kiirusteerinev(double kiirus1, double kiirus2) {
